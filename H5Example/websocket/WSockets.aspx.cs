...
namespace H5Example.websocket
{
    ...
    public partial class WSockets : System.Web.UI.Page
    {
        ...
        private async Task ProcessChat(AspNetWebSocketContext context)
        {
            ...
            string user = context.SecWebSocketKey;
                ...
                while (true)
                {
                    if (socket.State == WebSocketState.Open)
                    {
                        ...
                        try
                        {
                            ...
                            /*
                            if (CONNECT_POOL.ContainsKey(user))//判断客户端是否在线
                            {
